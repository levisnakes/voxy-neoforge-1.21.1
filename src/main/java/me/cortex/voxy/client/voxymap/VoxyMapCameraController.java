...
/**
 * Holds the virtual orbital camera for the 3D map view.
 * Ported from VoxyMap (3D-maps-Voxy-Addon); MC 1.21.1: dimension().location().
 */
public final class VoxyMapCameraController {
    ...
    public static void update(Minecraft minecraft, double centerX, double centerY, double centerZ, double yawRadians, double pitchControl, double blocksPerPixel) {
        ...
        boolean endDimension = "minecraft:the_end".equals(minecraft.level.dimension().location().toString());
